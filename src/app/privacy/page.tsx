  ...
  return (
    <main className="min-h-screen bg-surface-base">
      ...
      <div className="max-w-2xl mx-auto px-4 py-8 space-y-6">
        ...
        <p className="text-sm text-ink-sub">Last updated: March 9, 2026</p>
        ...
        <section className="space-y-3">
          <h2 className="font-serif text-xl text-ink">3. Data Storage & Security</h2>
          <p className="text-sm text-ink-sub leading-relaxed">
        ...
        <section className="space-y-3">
          <h2 className="font-serif text-xl text-ink">4. Your Rights</h2>
          <p className="text-sm text-ink-sub leading-relaxed">
        ...
        <section className="space-y-3">
          <h2 className="font-serif text-xl text-ink">5. Third-Party Services</h2>
          <p className="text-sm text-ink-sub leading-relaxed">
            We use the following third-party services to operate HomeProjectIQ:
          </p>
          <ul className="text-sm text-ink-sub leading-relaxed list-disc pl-5 space-y-1">
        ...
        <section className="space-y-3">
          <h2 className="font-serif text-xl text-ink">6. Cookies</h2>
          <p className="text-sm text-ink-sub leading-relaxed">
        ...
        <section className="space-y-3">
          <h2 className="font-serif text-xl text-ink">7. Contact</h2>
          <p className="text-sm text-ink-sub leading-relaxed">

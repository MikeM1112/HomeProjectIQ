...
export function BottomNav() {
  ...
  return (
    <nav aria-label="Main navigation" className="fixed bottom-0 left-0 right-0 z-40 bg-white border-t border-border pb-safe-bottom">
        ...
        {TABS.map((tab) => {
          ...
          return (
            <Link
              ...
              className={cn(
                'flex flex-col items-center gap-0.5 px-2 py-1 tap',
